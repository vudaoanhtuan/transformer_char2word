...
from dataset import Dataset, Tokenizer, load_tokenizer, NewMaskDatasetFT
...
if __name__ == "__main__":
    ...
    print("Prepare data")
    train_ds = NewMaskDatasetFT(args.train_file, tokenizer)
    test_ds = NewMaskDatasetFT(args.test_file, tokenizer)
