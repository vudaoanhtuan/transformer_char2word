...
from dataset import SingleDataset, SingleMaskDataset
...
if __name__ == "__main__":
    ...
    print("Prepare data")
    train_ds = SingleMaskDataset(args.train_file, tokenizer)
    test_ds = SingleMaskDataset(args.test_file, tokenizer, mask=False)
